...
Let’s begin by examining CDC reported case numbers in the U.S.:
...
Add some major milestone timepoints to our plot: \>Q2. Using the ggplot
...
example in the hint below). What do you notice? **Answer:** After
switching, there is an increase in cases.
...
The switch to the aP (newer acellular) formula created an increase in
cases for many countries such as Japan.

> Q3. Describe what happened after the introduction of the aP vaccine?
> Do you have a possible explanation for the observed trend?

**Answer:** The formula could simply be not as effected or well
formulated as the older one, less people could also be getting the
vaccine due to anti-vax sentiment.
...
the database tables in a key:value format like “infancy_vas”:“wP”. To
read this we can use the ‘read_json()’ function from the **jsonlite**
package.
...
**Answer:** There are more females than males and the majority of race
is white and asian. It is not very representative of the U.S.
...
The breakdown is not very representative of the U.S. - this is a serious
cavet for the study. However, it is still the largest sample of it’s
type ever assembled.
...
```
    ...
    6          1          wP         Female Not Hispanic or Latino White
      year_of_birth date_of_boost      dataset        age specimen_id
    1    1986-01-01    2016-09-12 2020_dataset 14582 days           1
    2    1986-01-01    2016-09-12 2020_dataset 14582 days           1
    3    1986-01-01    2016-09-12 2020_dataset 14582 days           1
    4    1986-01-01    2016-09-12 2020_dataset 14582 days           1
    5    1986-01-01    2016-09-12 2020_dataset 14582 days           1
    6    1986-01-01    2016-09-12 2020_dataset 14582 days           1
      actual_day_relative_to_boost planned_day_relative_to_boost specimen_type
    1                           -3                             0         Blood
    2                           -3                             0         Blood
    3                           -3                             0         Blood
...
```
    ...
    2    1986-01-01    2016-09-12 2020_dataset 14582 days           1
    3    1986-01-01    2016-09-12 2020_dataset 14582 days           1
    4    1986-01-01    2016-09-12 2020_dataset 14582 days           2
    5    1986-01-01    2016-09-12 2020_dataset 14582 days           2
    6    1986-01-01    2016-09-12 2020_dataset 14582 days           2
      actual_day_relative_to_boost planned_day_relative_to_boost specimen_type
    1                           -3                             0         Blood
    2                           -3                             0         Blood
    3                           -3                             0         Blood
...
code and biology knowledge to do it effectively.
