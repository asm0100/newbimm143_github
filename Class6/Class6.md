...
**arguments**, there can be multiple comma separated inputs to the
...
```
     ...
     [1] "C" "T" "C" "A" "T" "T" "C" "G" "T" "T" "T" "C" "T" "T" "T"

Turn this snipet into function that returns a user specified length DNA
...
```
     ...
     [1] "G" "C" "A" "A" "C" "T" "C" "A" "G" "A" "A" "C" "T" "T" "G"

I want the option to return a single element vector with my sequence all
together like this: “GGAGTAC”
...
A very useful third approach that is R specific is to use the ‘sapply()’
function.
...
```
    ...
    [1] "CRINUM"       "SIQRMTV"      "ULSQKRST"     "PDKWLUKLF"    "CYVDKVAKNP"  
    [6] "EQIYTDQUYCE"  "SYQDFUVSRRUU"

> **Key Point**: Writing functions in R is doable but not the easiest
> thing in the world starting with our working snippet of code then
